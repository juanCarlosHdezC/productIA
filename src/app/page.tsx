              ...
              <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3">
                ...
                <div className="grid gap-6">
                  <div className="flex flex-col justify-center space-y-4 rounded-lg border p-6 shadow-sm">
                    ...
                    <p className="text-muted-foreground">
                      Edita las descripciones a tu gusto y expórtalas
                      directamente a tu tienda o descárgalas.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="container px-4 md:px-6">
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Miles de empresas confían en DescribeAI para sus
              ...
              <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
                <div className="flex flex-col justify-between rounded-lg border bg-background p-6 shadow-sm">
                  <div className="space-y-4">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      conversiones han aumentado en un 27%. Las descripciones
                      son profesionales y realmente conectan con nuestros
                      clientes."
                    </p>
                  </div>
                ...
                <div className="flex flex-col justify-between rounded-lg border bg-background p-6 shadow-sm">
                  <div className="space-y-4">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      horas escribiendo descripciones, ahora generamos decenas
                      en minutos y son de mejor calidad."
                    </p>
                  </div>
                  <div className="mt-6 flex items-center space-x-4">
                    <div className="h-10 w-10 rounded-full bg-muted"></div>
                ...
                <div className="flex flex-col justify-between rounded-lg border bg-background p-6 shadow-sm">
                  <div className="space-y-4">
                    ...
                    <p className="text-muted-foreground">
                      "La integración con Shopify es perfecta. Nuestro catálogo
                      de 500+ productos fue actualizado con descripciones
                      optimizadas en un fin de semana."
                    </p>
                  </div>
                  <div className="mt-6 flex items-center space-x-4">
                    <div className="h-10 w-10 rounded-full bg-muted"></div>
              ...
              <div className="mx-auto max-w-3xl space-y-4 py-12">
                <div className="rounded-lg border bg-background p-6">
                  ...
                  <p className="mt-2 text-muted-foreground">
                    ...
                    funcionalidades del plan Pro. No requiere tarjeta de crédito
                ...
                <div className="rounded-lg border bg-background p-6">
                  ...
                  <p className="mt-2 text-muted-foreground">
                    Sí, ofrecemos integraciones con las principales plataformas
                    de e-commerce como Shopify, WooCommerce, PrestaShop y
                    Magento. Para otras plataformas, puedes exportar las
                    descripciones en diferentes formatos.
                  </p>
                </div>
                <div className="rounded-lg border bg-background p-6">
                  <h3 className="text-lg font-bold">
                ...
                <div className="rounded-lg border bg-background p-6">
                  ...
                  <p className="mt-2 text-muted-foreground">
                    Sí, cada descripción es única y generada específicamente
                    para tu producto. Además, puedes personalizar el tono y
                    estilo para que se adapte perfectamente a tu marca.
                  </p>
                </div>
                <div className="rounded-lg border bg-background p-6">
                  <h3 className="text-lg font-bold">
                  ...
                  <p className="mt-2 text-muted-foreground">
                    Por supuesto, puedes actualizar o reducir tu plan en
                    cualquier momento. Los cambios se aplicarán en tu próximo
