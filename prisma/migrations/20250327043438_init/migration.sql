...
CREATE TABLE `User` (
    ...
    `plan` VARCHAR(191) NULL DEFAULT 'Gratis',
...
CREATE TABLE `SeoAnalysis` (
    ...
    UNIQUE INDEX `SeoAnalysis_descriptionId_key`(`descriptionId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `SeoAnalysis` ADD CONSTRAINT `SeoAnalysis_descriptionId_fkey` FOREIGN KEY (`descriptionId`) REFERENCES `Description`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
